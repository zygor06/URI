    ...
    public static void main(String[] args){
        ...
        for(int i = 0; i < nomes.length; i++){
            ...
            try{
                ...
                writer.printf("    public static void main(String[] args){\n        //TODO: Codigo do problemas %s\n", nomes[i]);
                writer.print("    }\n\n}");
                writer.close();
            }catch (Exception e) {
                e.printStackTrace();
